...
Public Class Mapy
    ...
    Protected Overrides Sub InsertDefaultContent()
        ...
        Add(New JednaMapa("OpenStretMap", "https://www.openstreetmap.org/#map=16/%lat/%lon"))
        Add(New JednaMapa("Bing", "https://bing.com/maps/default.aspx?lvl=16&cp=%lat~%lon"))
        Add(New JednaMapa("Google", "https://www.google.pl/maps/@%lat,%lon,16z"))
        Add(New JednaMapa("WirtSzlaki", "https://mapa.wirtualneszlaki.pl/#16/%lat/%lon"))
        Add(New JednaMapa("ArcGIS", "https://www.arcgis.com/home/webmap/viewer.html?center=%lon,%lat&level=10"))
    End Sub
