...
Class MainWindow
    ...
    Private Async Sub Window_Loaded(sender As Object, e As RoutedEventArgs)
        ...
        Dim _oWinHttp = New Windows.Web.Http.HttpClient
        _oWinHttp.DefaultRequestHeaders.UserAgent.TryParseAdd(_defaultHttpAgent)
        _oWinHttp.DefaultRequestHeaders.Accept.Add(New Windows.Web.Http.Headers.HttpMediaTypeWithQualityHeaderValue("*/*"))
        _oWinHttp.DefaultRequestHeaders.AcceptLanguage.Add(New Windows.Web.Http.Headers.HttpLanguageRangeWithQualityHeaderValue("en-US"))
        '_oHttp.DefaultRequestHeaders.AcceptLanguage.Add(New Net.Http.Headers.StringWithQualityHeaderValue("en"))
        ' _oHttp.DefaultRequestHeaders.AcceptEncoding.Add(New Net.Http.Headers.StringWithQualityHeaderValue("gzip")) ' Accept-Encoding: gzip, deflate
        ...
        Dim oWinResp = Await _oWinHttp.GetAsync(New Uri("http://www.skyscrapercity.com/login"))
